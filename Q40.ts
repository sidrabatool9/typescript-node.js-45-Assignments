...
//  that value to the album’s Object. Make at least one new function call that includes the number 
// of tracks on an album.

function make_album(artist: string, title: string): {artist: string; title: string}{
    const dictionaries={
        artist: artist.charAt(0).toLowerCase() + artist.slice(1),
...
console.log(album)
 ...
 album = make_album("hamza","seembreeze")
console.log(album)
