...
// 1ST POINT:
let guestArr = ["Wasee", "Saba", "Laiba", "Wajahat"];
let canNotAttend = "Saba";
let newGuest = "Farwa";
guestArr[guestArr.indexOf(canNotAttend)] = newGuest;
console.log(guestArr);
guestArr.map((items) => console.log(`Dear ${items}, I found a bigger dinner table so i invited a more people`));
// 2ND POINT:
let guestBeg = "Sara";
